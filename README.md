...
- 그래서 root em인 rem 단위를 쓰는 것이 일관된 크기 조정에 용이하다.
...
- 수평거리 : 양수(오른쪽), 음수(왼쪽), 필수 속성
- 수직거리 : 양수(아래쪽), 음수(위쪽), 필수 속성
...
### 4.2.2 테두리 스타일을 지정하는 border-style 속성 (참고만)
...
- groove : 홈이 파인 듯한 입체 느낌
- inset, outset : 표에서 사용
- ridge : 튀어 나온 듯한 입체 느낌
